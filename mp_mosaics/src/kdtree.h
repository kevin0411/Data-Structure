...
class KDTree
{
  ...
  public:
    ...
    Point<Dim> findNearestNeighbor(const Point<Dim>& query, KDTreeNode* node, int curDim) const;
...
RandIter partition(RandIter begin, RandIter end, RandIter index, Comparator cmp);
