...
namespace cs225 {
  ...
  public:
    ...
    /**
      ...
      */
    BWPixel & getPixel(unsigned int x, unsigned int y);
    ...
    /**
      ...
      */
    const BWPixel & getPixel(unsigned int x, unsigned int y) const;
  ...
  private:
    ...
    BWPixel *imageData_;          /*< Array of pixels */
     ...
     */
    BWPixel & _getPixelHelper(unsigned int x, unsigned int y) const;
  };
